...
export default function SendEmail({ setSendEmail, data }) {
  ...
  const subject = `Customer Ledger - ${companyInfo?.companyName}`;
  const body = `
    <div>
    ...
    <div class="invoice-details">
      Total invoice count: ${data?.totalSaleInvoice}<br>
      Total return invoice count: ${data?.totalReturnSaleInvoice}<br>
    </div>
    <br>
