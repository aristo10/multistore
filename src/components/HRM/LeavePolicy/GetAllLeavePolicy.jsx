...
import { deleteLeavePolicy, loadAllLeavePolicyPaginated } from "@/redux/rtk/features/hrm/leavePolicy/leavePolicySlice";
...
export default function GetAllLeave() {
  ...
  const columns = [
    ...
    },
    {
        ...
        render: ({id, status}) => [
          {
            label: <ViewBtn title={"View"} path={`/admin/hrm/leave-policy/${id}`} />,
            key: "view",
          },
          {
            label: (
