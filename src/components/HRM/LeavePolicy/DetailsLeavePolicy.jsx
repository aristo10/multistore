...
import { clearLeavePolicy, loadSingleLeavePolicy } from "@/redux/rtk/features/hrm/leavePolicy/leavePolicySlice";
    ...
    },
{
  ...
  render: ({user}) => [
    {
      label: <ViewBtn title={"View"} path={`/admin/hrm/staff/${user?.id}`} />,
      key: "view",
    },
  ],
  csvOff:true,
