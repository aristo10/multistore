  ...
  return (
    ...
    <div>

        {
              job ?  
              <div>
                  <Card title={"Job Information"} extra={
                    <Popover
                    className='mr-1'
                    content={
                      <Menu
                  ...
                  >
                    <BsThreeDotsVertical className='cursor-pointer text-base' />
                      ...
                      <List className="w-full"  labelClassName='w-[40%]'
                              list={[
                                {
                                  label: "Company",
                                ...
                                {
                                  label: "Job Skills",
                                  value: job.jobSkills.map(skills => <Tag key={skills.id} color={'blue'}>{skills.jobSkills.jobSkillName}</Tag>),
                                },
                                {
                                  label: "Total Vacancy",
                      ...
                      <List className="w-full" labelClassName='w-[40%]'
                              list={[
                                ...
                                {
                                  label: "Salary",
                                  value: job.jobPaySystem ==="exactSalary" ? job.exactSalary :`${job.startingSalary} - ${job.maximumSalary}`,
                                },
                                {
                                  label: "Pay By",
                                  value: job.jobPayBy,
