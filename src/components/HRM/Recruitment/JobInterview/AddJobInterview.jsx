...
import { addJobInterview, loadAllJobInterview } from "@/redux/rtk/features/hrm/jobInterview/jobInterviewSlice";
...
const AddJobInterview = () => {
    ...
    const {list:jobApplicationList, loading:jobApplicationLoading} = useSelector(state=>state.jobApplication)
    const {list:userList, loading:userLoading} = useSelector(state=>state.users)
