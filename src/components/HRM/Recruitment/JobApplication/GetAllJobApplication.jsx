...
import { deleteJobApplication, editJobApplication, loadAllJobApplicationPaginated } from '@/redux/rtk/features/hrm/jobApplication/jobApplicationSlice';
...
export default function GetAllJobApplication() {
   ...
   const {jobApplicationStatus} = useSelector(state=> state.jobApplication);
...
const columns = [
    ...
    },
    {
              ...
              render: (item) => [
                {
                    label: <ViewBtn title={"View"} path={`/admin/hrm/job-application/${item.id}`} />,
                    key: "view",
                  },
                {
                  label: (
