        ...
        >
          <div className='my-4 xl:px-8'>
            ...
            <div>
              ...
              <div className='mt-2'>
                <Table
                  columns={columnsOtherStock}
                  data={product?.stockStoreInfo?.filter(
                    (item) => item.storeId !== product?.stockInfo[0]?.storeId
                  )}
                />
              </div>
            </div>
