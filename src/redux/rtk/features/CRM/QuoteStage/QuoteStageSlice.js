...
export const addQuoteStage = createAsyncThunk(
  ...
  async (values) => {
    try {
      ...
      return successHandler(data, "Task priority Created Successfully");
    } catch (error) {
...
export const updateQuoteStage = createAsyncThunk(
  ...
  async ({ id, values }) => {
    try {
      ...
      return successHandler(data, "Task priority Updated Successfully");
    } catch (error) {
      return errorHandler(error);
    }
  },
...
export const deleteQuoteStage = createAsyncThunk(
  ...
  async (id) => {
    try {
      ...
      return successHandler(data, `Task Priority Deleted Successfully`);
    } catch (error) {
      return errorHandler(error, true);
    }
  },
...
export const deleteManyQuoteStage = createAsyncThunk(
  ...
  async (arg) => {
    try {
      ...
      return successHandler(data, "Task Stages Deleted Successfully");
    } catch (error) {
      return errorHandler(error, true);
    }
  },
