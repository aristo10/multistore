...
export const addTicketStatus = createAsyncThunk(
  ...
  async (values) => {
    try {
      ...
      return successHandler(data, "Ticket priority Created Successfully");
    } catch (error) {
...
export const updateTicketStatus = createAsyncThunk(
  ...
  async ({ id, values }) => {
    try {
      ...
      return successHandler(data, "Ticket priority Updated Successfully");
    } catch (error) {
      return errorHandler(error);
    }
  },
...
export const deleteTicketStatus = createAsyncThunk(
  ...
  async (id) => {
    try {
      ...
      return successHandler(data, `Ticket Priority Deleted Successfully`);
    } catch (error) {
      return errorHandler(error, true);
    }
  },
...
export const deleteManyTicketStatus = createAsyncThunk(
  ...
  async (arg) => {
    try {
      ...
      return successHandler(data, "Ticket Statuses Deleted Successfully");
    } catch (error) {
      return errorHandler(error, true);
    }
  },
