...
function Header({ onPress, data, loading, isSideNavNan }) {
  ...
  const { list, defaultStore } = useSelector((state) => state.store);
            ...
            <Popover
              ...
              content={
                <div className='min-w-[150px] rounded-lg'>
                  ...
                  {defaultStore && (
                    <div className='px-3 py-2 hover:bg-slate-200 rounded-lg'>
                      <Dropdown
                      ...
                      >
                        <a
                          ...
                          className='flex gap-2 items-center hover:bg-slate-200'
                        >
                          <FaStore />
                          {defaultStore?.name}
