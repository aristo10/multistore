...
import AdminLayoutWithoutSideNav from "./layouts/AdminLayoutWithoutSideNav";
import useAdminRoutes from "./layouts/AdminRoutes";
import useAdminRoutesForNoSideNav from "./layouts/AdminRoutesForNoSideNav";
...
function App() {
  ...
  const AdminRoutesForNoSideNav = useAdminRoutesForNoSideNav();
  ...
  if (loading || DemoLoading) content = <LoaderSpinner />;
    ...
    content = (
      <Routes>
        ...
        <Route
          path='/admin'
          element={<AdminLayoutWithoutSideNav />}
          key='Admin-without-side-nav'
        >
          {AdminRoutesForNoSideNav}
        </Route>
